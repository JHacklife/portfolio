    ...
    <Stack id="about">
      <Stack className="welcome" justifyContent="center" alignItems="center" spacing={3} px={5}>
        ...
        <Grid container spacing={2} sx={{
          ...
          <Grid item><img src={profileIMG} alt="profile" height="100%" width="300px" style={{ objectFit: 'cover' }} /></Grid>
          ...
          <Grid item md flexWrap="wrap">
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={6} md={4}>
                <Data title="Premios y menciones" custom={
                  <Typography variant="caption" color="tertiary.main" align="left" mt={0.5} lineHeight={1.2}>
              ...
              <Grid item xs={6} md={4}>
                <Data title="Experiencias" custom={
