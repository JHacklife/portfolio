      ...
      <Grid container spacing={2} sx={{
        ...
        <Grid item md flexWrap="wrap">
          ...
          <Stack direction="row" spacing={1} justifyContent="space-between">
            <Typography variant="h3" bgcolor="primary.main" color="primary.dark" align="left" px={1}>Jonathan C. Wildemer</Typography>
            <Square color="grey" />
          </Stack>

          {/* CARGO */}
          <Typography variant="h4custom" color="secondary.main" align="left" mt={0} width="100%">FULLSTACK DEVELOPER</Typography>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} md={4}>
              <CustomData title="Estudiando" description={<Typography variant="caption" color="text.main" align="left" mt={0.5} lineHeight={1.2}>
